...
from axiom_bdx.placo_walk_engine import PlacoWalkEngine
from axiom_bdx.utils.mujoco_utils import check_contact
from axiom_bdx.utils.rl_utils import action_to_pd_targets, mujoco_to_isaac
from axiom_bdx.utils.xbox_controller import XboxController
from axiom_bdx.utils.rl_utils import (
    isaac_to_mujoco,
)
...
pwe = PlacoWalkEngine("../../axiom_bdx/robots/bdx/robot.urdf")


model = mujoco.MjModel.from_xml_path("../../axiom_bdx/robots/bdx/scene.xml")

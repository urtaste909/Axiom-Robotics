...
bdx_mujoco_server = StratMujocoServer(
    model_path="/home/antoine/MISC/mini_Strat/axiom_bdx/robots/bdx"
)
...
robot = placo.RobotWrapper(
    "../../axiom_bdx/robots/bdx/robot.urdf", placo.Flags.ignore_collisions
)
